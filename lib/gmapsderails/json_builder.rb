module Gmapsderails  
  # the to_gmapsderails method accepts a block to customize:
  # - infowindow
  # - picture
  # - title
  # - sidebar
  ...
  #
  # This works this way:
  #   @json = User.all.to_gmapsderails do |user, marker|
  ...
  class JsonBuilder
    ...
    def initialize(object)
      ...
      @options = OpenStruct.new @object.gmapsderails_options
    end
    ...
    def model_attributes
      { 
        :description    => :gmapsderails_infowindow,
        :title          => :gmapsderails_title,
        :sidebar        => :gmapsderails_sidebar,
        :marker_picture => :gmapsderails_marker_picture
    ...
    def position_from_array?
      position #if gmapsderails_options[:position] is filled, means user is indicating an array
    end
