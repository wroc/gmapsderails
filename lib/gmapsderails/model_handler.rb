module Gmapsderails
  class ModelHandler
    ...
    def initialize(object, gmapsderails_options)
      @options = ::OpenStruct.new(gmapsderails_options)
      @object  = object
    end
    ...
    def get_coordinates
      Gmapsderails.geocode(object.send(address), language, false, protocol)
    ...
    def condition_eval(*args)
      Gmapsderails.condition_eval(*args)
    end
